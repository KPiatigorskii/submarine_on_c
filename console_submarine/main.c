...
/*
проверки для расположения корабля
1)выбранная рандомная клетка свободна
2) 8 ее соседей НЕ больше нуля
3) проверяем количество клеток до выхода за пределы массива с учетом длины корабля
4) проверяем что клетки по направлению движения корабля равны нулю

выставление корабля
1) выставляем в зависимости от направления корабля единицы
2) выставляем -1 вокруг корабля
*/
